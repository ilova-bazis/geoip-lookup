...
// Example usage
const rawData = `#ISO	ISO3	ISO-Numeric	fips	Country	Capital	Area(in sq km)	Population	Continent	tld	CurrencyCode	CurrencyName	Phone	Postal Code Format	Postal Code Regex	Languages	geonameid	neighbours	EquivalentFipsCode
...
//   const parsedData = parseCountryData(rawData);
...
for (const line of lines) {
    ...
    if (parsedData) {
        ...
        //         currency_code: parsedData.CurrencyCode,
        //         currency_name: parsedData.CurrencyName,
        //         equivalent_fips_code: parsedData.EquivalentFipsCode,
        //         fips: parsedData.fips,
        //         geoname_id: parsedData.geonameid,
        //         iso: parsedData.ISO,
        //         iso3: parsedData.ISO3,
        //         iso_numeric: parsedData.ISONumeric,
        //         languages: parsedData.Languages,
        //         neighbours: parsedData.neighbours,
        //         phone: parsedData.Phone,
        //         population: parsedData.Population,
        //         postal_code_format: parsedData.PostalCodeFormat,
        //         postal_code_regex: parsedData.PostalCodeRegex,
        //         tld: parsedData.tld,
