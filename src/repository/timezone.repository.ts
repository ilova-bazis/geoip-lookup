...
const rawData = `CountryCode	TimeZoneId	GMT offset 1. Jan 2024	DST offset 1. Jul 2024	rawOffset (independant of DST)
...
class TimeZoneRepository {
    timeZoneData: { [id: string]: TimeZoneData};
    constructor(timeZoneData: { [id: string]: TimeZoneData}) {
        this.timeZoneData = timeZoneData;
    }

    get(id: string): TimeZoneData | null {
